...
import { ModalButtons, ModalContent } from '@/organisms/Modals/Modal/ModalButtons'
...
const ModalDemoCloseOnOverlayClick = () => {
  const { isOpen, onOpen, onClose } = useDisclosure()
