import{a as e,F as i,j as o,M as n,b as t,c as r,C as a}from"./index.23c60f83.js";function l(){return e(i,{children:e("p",{children:"Ejemplo modal"})})}const d=()=>o(i,{children:[e(n,{children:"ModalAlert"}),o(t,{children:["Componente que muestra una alerta en forma de modal, se puede mostrar con un 1 o 2 botones y contiene 4 tipos de alertas:",e("code",{children:" warning, error, success e info"}),".",e("br",{}),e("br",{}),"El modal se pegara al provider de ",e("code",{children:"Chakra-ui"})," de la aplicacion, de tal modo que hara el portal desde el root de la aplicacion, asegurando que siempre se muestre por encima de cualquier componente"]}),e(r,{children:"Types definidos"}),e(t,{children:"La modal se comporta bajo los siguientes types:"}),e(a,{text:`//Propiedades del modal
export interface ModalAlertProps {
  ...
  description?: string // Mensaje del modal (admite etiquetas HTML b\xE1sicas sanitizadas)
...
//# sourceMappingURL=ModalAlert.986da0cc.js.map
