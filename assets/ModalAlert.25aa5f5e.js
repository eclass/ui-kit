import{a as e,F as n,j as o,M as i,b as t,c as r,C as a}from"./index.4e3fe3db.js";function l(){return e(n,{children:e("p",{children:"Ejemplo modal"})})}const d=()=>o(n,{children:[e(i,{children:"ModalAlert"}),o(t,{children:["Componente que muestra una alerta en forma de modal, se puede mostrar con un 1 o 2 botones y contiene 4 tipos de alertas:",e("code",{children:" warning, error, success e info"}),".",e("br",{}),e("br",{}),"El modal se pegara al provider de ",e("code",{children:"Chakra-ui"})," de la aplicacion, de tal modo que hara el portal desde el root de la aplicacion, asegurando que siempre se muestre por encima de cualquier componente"]}),e(r,{children:"Types definidos"}),e(t,{children:"La modal se comporta bajo los siguientes types:"}),e(a,{text:`//Propiedades del modal
...
//# sourceMappingURL=ModalAlert.25aa5f5e.js.map
