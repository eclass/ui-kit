...
interface ICalendarDropdown {
  ...
  onlyToCalendar?: boolean // Si es true, no despliega el men\xFA, solo redirige al calendario, usado en campus virtual
                ...
                `}),e(o,{children:"onClickEvent"}),r(a,{children:["El prop ",e("strong",{children:"onClickEvent"})," es opcional. Si se env\xEDa, se ejecuta al presionar un evento del dropdown siempre que ese evento tambi\xE9n tenga ",e("strong",{children:"url"}),", y entrega hacia arriba la informaci\xF3n completa del evento seleccionado. Los eventos sin URL no ejecutan el callback."]}),e(n,{text:`
<CalendarDropdown
  events={events}
